...
public class Nivel2 extends AppCompatActivity implements View.OnTouchListener, View.OnDragListener {
    ...
    int listaImagenes[] = {
            ...
            R.drawable.percepcion_a,
            R.drawable.percepcion_e,
            R.drawable.percepcion_i,
            R.drawable.percepcion_o,
            R.drawable.percepcion_u,
            R.drawable.percepcion_gmayus,
            R.drawable.percepcion_gminus,
            R.drawable.percepcion_pmayus,
            R.drawable.percepcion_pminus};
    ...
    public void asociar() {
        ...
        mp = MediaPlayer.create(this,R.raw.nuevo_nivel);
        mp.start();
        try {
            Thread.sleep(6000);
    ...
    public void instruccion() {
        ...
        for (int g = 0; g <= 3; g++) {
            num = (int) (Math.random() * 14); //Para meter en la pila tanto numeros y letras
        ...
        do {
            num2 = (int) (Math.random() * 9); //solo generar numeros, no las letras
            ...
            if (direc.equals("izquierda")) {
                if (pos1 == true && pos1temp == true && v.getTag().equals("destinoIzquierda")) {
                    ...
                    if (contadorPierde == 0) {
                        ...
                        mp.start();
                        Toast.makeText(this, "Perdiste amiguito :c", Toast.LENGTH_LONG).show();
                        Toast.makeText(this, "La ventana se cerrará", Toast.LENGTH_SHORT).show();
                        ...
                        //txtvContador.setText("Te quedan: " + contador + " intentos");
                ...
                if (pos1 == true && pos1temp == true && v.getTag().equals("destinoDerecha")) {
                    ...
                    if (contadorPierde == 0) {
                        ...
                        mp = MediaPlayer.create(this, R.raw.perdiste);
                        mp.start();
                        Toast.makeText(this, "Perdiste amiguito :c", Toast.LENGTH_SHORT).show();
                        Toast.makeText(this, "La ventana se cerrará", Toast.LENGTH_SHORT).show();
                        new Timer().schedule(new TimerTask() {
                            @Override
                            public void run() {
